...
function enjoylife_sidebar_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'footer',
		'description'   => esc_html__( '4 Columns widget area.', 'enjoylife' ),
...
function enjoylife_scripts() {
    ...
    wp_enqueue_style( 'enjoylife-style', get_stylesheet_uri(), array(), '20210720' );
    wp_enqueue_style( 'genericons-style',   get_template_directory_uri() . '/genericons/genericons.css' );
    wp_enqueue_style( 'enjoylife-responsive-style',   get_template_directory_uri() . '/responsive.css', array(), '20210720' ); 
